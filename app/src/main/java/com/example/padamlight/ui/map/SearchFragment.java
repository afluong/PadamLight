...
import com.example.padamlight.utils.CheckInternet;
...
public class SearchFragment extends Fragment {
    ...
    void onClickSearch() {
        if (CheckInternet.checkInternetConnectivity(getActivity())) {
             /*
         ...
         */
            ...
            Toast.makeText(getActivity(), getText(R.string.no_connexion_error), Toast.LENGTH_SHORT).show();
        }
